...
# MAGIC     <li>Materializa os 13 notebooks em <code>pyspark_free/pt_br/</code> + <code>_assistant_runtime.py</code> (assistente AI Athena)</li>
# MAGIC   </ol>
# MAGIC </div>
...
# MAGIC   <p style="margin:0;font-size:1.05em;opacity:.95;line-height:1.55">Abra a pasta <strong>pyspark_free/</strong> no seu workspace.<br>Comece pelo <code>pt_br/00_auxiliar_gerador_dados_para_ingestao.py</code> e siga a ordem dos números.<br><br>Para usar o assistente AI, em qualquer notebook: <code>%run ./_assistant_runtime</code> e depois <code>chat("sua pergunta")</code>. Funciona em Databricks Free com a mesma chave do bundle.</p>
# MAGIC </div>
