...
# MAGIC   <p style="margin:0;font-size:1.1em;opacity:.95;line-height:1.55">Este notebook é a porta de entrada. Cole sua <strong>chave de acesso</strong> e rode todas as células — os <strong>13 notebooks</strong> do curso em português vão aparecer no seu workspace. A versão em inglês sai em breve.</p>
# MAGIC </div>
...
# MAGIC     <li>Materializa os 13 notebooks em <code>pyspark_free/pt_br/</code></li>
# MAGIC   </ol>
# MAGIC </div>
...
PAYLOAD_URLS = [
    "https://raw.githubusercontent.com/AprenderDados/public-files/main/public-files/courses/pyspark_free_pt/payload.private.json",
]
...
# Onde vai gravar. Por padrão, ao lado deste notebook.
notebook_path = (
...
# MAGIC   <p style="margin:0;font-size:1.05em;opacity:.95;line-height:1.55">Abra a pasta <strong>pyspark_free/</strong> no seu workspace.<br>Comece pelo <code>pt_br/00_auxiliar_gerador_dados_para_ingestao.py</code> e siga a ordem dos números.</p>
# MAGIC </div>
