...
# MAGIC     <li>Materializa os 13 notebooks em <code>pyspark_free/pt_br/</code> + setup do agente em <code>pyspark_free/pt_br/agente/</code></li>
# MAGIC   </ol>
# MAGIC </div>
...
# MAGIC   <p style="margin:0;font-size:1.05em;opacity:.95;line-height:1.55">Abra a pasta <strong>pyspark_free/</strong> no seu workspace.<br>Comece pelo <code>pt_br/00_auxiliar_gerador_dados_para_ingestao.py</code> e siga a ordem dos números.<br><br>O <code>pt_br/agente/</code> contém o setup do agente Athena para este curso — só funciona em <strong>workspace pago</strong> com Vector Search habilitado.</p>
# MAGIC </div>
