...
# MAGIC   <p style="margin:0;font-size:1.1em;opacity:.95;line-height:1.55">This notebook is the entry point. Paste your <strong>access key</strong> and run all cells — the <strong>16 notebooks</strong> of the course in English will appear in your workspace.</p>
# MAGIC </div>
...
# MAGIC   <h3 style="margin:0 0 12px;color:#6B3FA0;font-size:1.2em">📋 What this notebook does</h3>
...
# MAGIC     <li>Materializes the 16 notebooks in <code>gen_ai_engineer/en/</code></li>
# MAGIC   </ol>
# MAGIC </div>
...
PAYLOAD_URLS = [
    "https://raw.githubusercontent.com/AprenderDados/public-files/main/public-files/courses/gen_ai_engineer_en/payload.private.json",
]
...
try:
    ...
    _key_path = f"/Workspace/Users/{_current_user}/.gen_ai_engineer_en_key"
...
# MAGIC   <p style="margin:0;font-size:1.05em;opacity:.95;line-height:1.55">Open the <strong>gen_ai_engineer/</strong> folder in your workspace.<br>Start with the first notebook in <code>en/</code> and follow the numbering order. The last one (<code>91_assistant_ai_athena</code>) connects you to Athena, the course's AI assistant.</p>
# MAGIC </div>
