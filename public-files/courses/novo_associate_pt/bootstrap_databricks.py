...
# MAGIC   <p style="margin:0;font-size:1.1em;opacity:.95;line-height:1.55">Este notebook é a porta de entrada. Cole sua <strong>chave de acesso</strong> e rode todas as células — os <strong>22 notebooks</strong> do curso em português vão aparecer no seu workspace. A versão em inglês sai em breve.</p>
# MAGIC </div>
