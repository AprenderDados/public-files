...
# MAGIC   <h3 style="margin:0 0 12px;color:#2A9D8F;font-size:1.2em">📋 O que este notebook faz</h3>
...
ACCESS_KEY = "SDP-PT-2026"  # ⚠️ modo teste — substituir por "" antes do lançamento
