...
# MAGIC   <p style="margin:0;font-size:1.1em;opacity:.95;line-height:1.55">Este notebook é a porta de entrada. Cole sua <strong>chave de acesso</strong> e rode todas as células — os <strong>11 notebooks + assistente Athena</strong> do curso em português vão aparecer no seu workspace.</p>
# MAGIC </div>
...
# MAGIC   <h3 style="margin:0 0 12px;color:#C73E1D;font-size:1.2em">📋 O que este notebook faz</h3>
...
# MAGIC     <li>Materializa os 11 notebooks + assistente Athena em <code>professional_de2/pt_br/</code></li>
# MAGIC   </ol>
# MAGIC </div>
...
PAYLOAD_URLS = [
    "https://raw.githubusercontent.com/AprenderDados/public-files/main/public-files/courses/professional_de2_pt/payload.private.json",
]
...
# MAGIC   <p style="margin:0;font-size:1.05em;opacity:.95;line-height:1.55">Abra a pasta <strong>professional_de2/</strong> no seu workspace.<br>Comece pelo primeiro notebook em <code>pt_br/</code> e siga a ordem dos números.</p>
# MAGIC </div>
